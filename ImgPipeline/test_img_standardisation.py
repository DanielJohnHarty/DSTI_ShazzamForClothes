...
test_dog_img = os.path.join(current_path, "TestFiles", "test_dog.jpeg")
test_dog_img_renamed = os.path.join(current_path, "TestFiles", "test_dog_jpeg.jpeg")
robot_img = os.path.join(current_path, "TestFiles", "robot.jpg")
